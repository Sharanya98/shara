...
<body><div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel"><div class="carousel-inner"><div class="p-3 carousel-item active"><img src="/images/chart 1.jpg" class="d-block w-100"><div class="carousel-caption absolute text-center"></div></div><div class="p-3 carousel-item"><img src="/images/chart 2.jpg" class="d-block w-100"><div class="carousel-caption  absolute text-center"></div></div><div class="p-3 carousel-item"><img src="/images/chart 3.jpg" class="d-block w-100"><div class="carousel-caption absolute text-center"></div></div><div class="p-3 carousel-item"><img src="/images/chart 4.jpg" class="d-block w-100"><div class="carousel-caption absolute text-center"></div></div><a class="carousel-control-prev " href="#carouselExampleIndicators2" role="button" data-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="sr-only">Previous</span></a><a class="carousel-control-next" href="#carouselExampleIndicators2" role="button" data-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="sr-only">Next</span></a></div><!-- Indicator start --><div class="carousel-indicators"><button type="button" data-target="#carouselExampleIndicators2" class="active img-thumbnail" data-slide-to="0"><img src="/images/chart 1.jpg" alt="" class="d-block w-100"></button><button type="button" data-target="#carouselExampleIndicators2" class="img-thumbnail" data-slide-to="4"><img src="/images/chart 2.jpg" alt="" class="d-block w-100"></button><button type="button" data-target="#carouselExampleIndicators2" class="img-thumbnail" data-slide-to="5"><img src="/images/chart 3.jpg" alt="" class="d-block w-100"></button><button type="button" data-target="#carouselExampleIndicators2" class="img-thumbnail" data-slide-to="6"><img src="/images/chart 4.jpg" alt="" class="d-block w-100"></button></div></div>
